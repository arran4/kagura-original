...
public class ReportBean {
    ...
    public Map<String, Object> getReportsDetailed(@Header("reportId") String reportId, Exchange exchange)
    ...
    public Map<String, Object> run(
        ...
        if (all) reportConnector.setPageLimit(serverBean.getExportLimit());
    ...
    public Map<String, Object> generateExtraRunOptions(
            final AuthBean.AuthDetails authDetails,
            final Collection<String> groups,
            final Map<String, Object> userExtra) {
