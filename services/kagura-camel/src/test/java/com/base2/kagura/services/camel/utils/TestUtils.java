...
public class TestUtils {
    ...
    public static AbstractApplicationContext buildContext() {
        ClassPathXmlApplicationContext classPathXmlApplicationContext =
                new ClassPathXmlApplicationContext("/META-INF/spring/test.xml");
        ...
        FileAuthentication fileAuthentication =
                (FileAuthentication) classPathXmlApplicationContext.getBean("fileAuthentication");
        fileAuthentication.setConfigPath(getResourcePath("TestReports"));
        FileReportsProvider fileReportsProvider =
                (FileReportsProvider) classPathXmlApplicationContext.getBean("fileReportsProvider");
